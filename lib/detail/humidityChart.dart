...
class MyHumidityChart extends StatefulWidget {
  List<dynamic> data = [];
  MyHumidityChart({super.key, required this.data});

  @override
  State<MyHumidityChart> createState() => _MyHumidityChartState();
}

class _MyHumidityChartState extends State<MyHumidityChart> {
