...
class MyLightChart extends StatefulWidget {
  List<dynamic> data = [];
  MyLightChart({super.key, required this.data});

  @override
  State<MyLightChart> createState() => _MyLightChartState();
}

class _MyLightChartState extends State<MyLightChart> {
