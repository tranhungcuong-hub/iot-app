...
class _PumpbuttonState extends State<Pumpbutton> {
  ...
  Future _fetchData() async {
    final response = await http.get(Uri.parse(
        'https://io.adafruit.com/api/v2/trungbui2405/feeds/dadn.maybom/data'));
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {},
                    child: const Text(
                      'Press button to turn pump on or off',
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      FlutterSwitch(
                        ...
                        activeIcon: const Icon(FontAwesomeIcons.pumpSoap),
                        inactiveIcon: const Icon(FontAwesomeIcons.pumpSoap),
                        onToggle: (val) {
                          setState(() {
                            if (val) {
                              createData("1");
